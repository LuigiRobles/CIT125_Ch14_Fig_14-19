...
// Ch.14 pg.536 Fig.14-19 sales amount program
// Saves records to a sequintial access file
// and calculates amd displays the total
...
int getChoice()
{
	//display menu and returns choice
	int menuChoice = 0;
